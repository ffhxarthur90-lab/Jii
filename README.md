...
local listfastattack = {'Normal Attack','Fast Attack','Super Fast Attack'}
    ...
    local DropdownDelayAttack = Tabs.Main:AddDropdown("DropdownDelayAttack", {
        ...
        Description = "Chá»n Tá»‘c Äá»™ ÄÃ¡nh",
    ...
    spawn(function()
        ...
        local ToggleCandy = Tabs.Main:AddToggle("ToggleCandy", {Title = "Auto Farm Candy ( Only Max Level )",Description = "CÃ y Káº¹o ( Chá»‰ Cáº¥p Äá»™ Tá»‘i Äa )", Default = false })
...
--------------------------------------------------------------------------------------------------------------------------------------------
    ...
    local ToggleMobAura = Tabs.Main:AddToggle("ToggleMobAura", {
        ...
        Description = "ÄÃ¡nh QuÃ¡i á»ž Gáº§n",
        Default = false })
    ...
    local ToggleCastleRaid = Tabs.Main:AddToggle("ToggleCastleRaid", {
        ...
        Description = "ÄÃ¡nh Háº£i Táº·c á»Ÿ PhÃ¡o ÄÃ i", 
        Default = false })
...
local Mastery = Tabs.Main:AddSection("Mastery Farm")
    local DropdownMastery = Tabs.Main:AddDropdown("DropdownMastery", {
        Title = "Mastery Mode",
        Description = "Chá»n Cháº¿ Äá»™ ThÃ´ng Tháº¡o",
    ...
    local ToggleMasteryFruit = Tabs.Main:AddToggle("ToggleMasteryFruit", {
        ...
        Description = "CÃ y ThÃ´ng Tháº¡o TrÃ¡i", 
        Default = false })
    ...
    local SliderHealt = Tabs.Main:AddSlider("SliderHealt", {
        Title = "Health (%) Mob",
        Description = "Pháº§n TrÄƒm MÃ¡u QuÃ¡i",
        Default = 25,
        Min = 0,
        Max = 100,
        Rounding = 1,
...
local ToggleRandomBone = Tabs.Main:AddToggle("ToggleRandomBone", {Title = "Random Bone",Description = "Äá»•i xÆ°Æ¡ng", Default = false })
	...
	while wait() do
		pcall(function()
			...
			elseif string.len(game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("CakePrinceSpawner")) == 86 then
				...
				Mob_Kill_Cake_Prince:SetDesc("Cake Prince : ðŸŸ¢yes")
			end
		end)
	end
end)
...
local ToggleCake = Tabs.Main:AddToggle("ToggleCake", {
    ...
    Description = "CÃ y TÆ° Lá»‡nh Bá»™t", 
    Default = false })
...
spawn(function()
    ...
    local ToggleSpawnCake = Tabs.Main:AddToggle("ToggleSpawnCake", {
        ...
        Description = "Tá»± Äá»™ng Triá»‡u Há»“i TÆ° lá»‡nh Bá»™t", 
        Default = true })
...
spawn(function()
  while wait() do
    ...
    local ToggleVatChatKiDi = Tabs.Main:AddToggle("ToggleVatChatKiDi", {
        ...
        Description = "CÃ y váº­t Cháº¥t kÃ¬ Dá»‹", 
        Default = false })
...
local boss = Tabs.Main:AddSection("Boss Farm")
    ...
    local DropdownMaterial = Tabs.Main:AddDropdown("DropdownMaterial", {
        Title = "Dropdown",
        Description = "Chá»n NguyÃªn Liá»‡u",
        Values = MaterialList,
        Multi = false,
        Default = 1,
    })
    ...
    local ToggleMaterial = Tabs.Main:AddToggle("ToggleMaterial", {
        Title = "Auto Material",
        Description = "CÃ y NguyÃªn Liá»‡u", 
        Default = false })
...
function UpdateKitsune()
    if game.Workspace._WorldOrigin.Locations:FindFirstChild('Kitsune Island') then
        StatusKitsune:SetDesc("Kitsune Island : ðŸŸ¢yes")
    else
        StatusKitsune:SetDesc("Kitsune Island : ðŸ”´no")
     end
end
spawn(function()
    pcall(function()
      ...
      local ToggleEspKitsune = Tabs.Main:AddToggle("ToggleEspKitsune", {Title = "Esp Kitsune Island",Description = "Äá»‹nh vá»‹ Äáº£o kisune", Default = false })
      ...
      local ToggleTPKitsune = Tabs.Main:AddToggle("ToggleTPKitsune", {Title = "Tween To Kitsune Island",Description = "Di Chuyá»ƒn Äáº¿n Äáº£o Kisune", Default = false })
      ...
      local ToggleCollectAzure = Tabs.Main:AddToggle("ToggleCollectAzure", {Title = "Collect Azure Ambers",Description = "Nháº·t Há»“n Lá»­a", Default = false })
...
if Third_Sea then
    ...
    local ToggleSailBoat = Tabs.Main:AddToggle("ToggleSailBoat", {Title = "Auto buy Boat",Description = "Mua Thuyá»n + Ngá»“i VÃ o", Default = false })
...
spawn(function()
	...
	Description = "Chá»‰nh tá»‘c Ä‘á»™ thuyá»n",
	Default = 300,
	Min = 0,
	Max = 1000,
	Rounding = 1,
...
local SpeedBoatToggle = Tabs.Main:AddToggle("SpeedBoat_Toggle", {Title = "Speed Boat",Description = "Tá»‘c Ä‘á»™ thuyá»n", Default = false })
...
game:GetService("RunService").RenderStepped:Connect(function()
    ...
    local ToggleTerrorshark = Tabs.Main:AddToggle("ToggleTerrorshark", {Title = " Kill Terrorshark",Description = "ÄÃ¡nh Terrorshark", Default = false })
    ...
    spawn(function()
     ...
     local TogglePiranha = Tabs.Main:AddToggle("TogglePiranha", {Title = " Kill Piranha",Description = "ÄÃ¡nh Piranha", Default = false })
     ...
     local ToggleShark = Tabs.Main:AddToggle("ToggleShark", {Title = " Kill Shark",Description = "ÄÃ¡nh CÃ¡", Default = false })
    ...
    local ToggleFishCrew = Tabs.Main:AddToggle("ToggleFishCrew", {Title = " Kill Fish Crew",Description = "ÄÃ¡nh Fish Crew", Default = false })
    ...
    local ToggleShip = Tabs.Main:AddToggle("ToggleShip", {Title = "Kill Ship",Description = "ÄÃ¡nh Thuyá»n Háº£i Táº·c", Default = false })
...
while wait() do
    ...
    local ToggleGhostShip = Tabs.Main:AddToggle("ToggleGhostShip", {Title = "Kill Ghost Ship",Description = "ÄÃ¡nh Thuyá»n Ma",Default = false })
        ...
        while wait() do
            pcall(function()
                if game:GetService("ReplicatedStorage"):FindFirstChild("Diablo") or game:GetService("ReplicatedStorage"):FindFirstChild("Deandre") or game:GetService("ReplicatedStorage"):FindFirstChild("Urban") or game:GetService("Workspace").Enemies:FindFirstChild("Diablo") or game:GetService("Workspace").Enemies:FindFirstChild("Deandre") or game:GetService("Workspace").Enemies:FindFirstChild("Urban") then
                    StatusElite:SetDesc("Elite Boss : ðŸŸ¢yes | Killed:  "..game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("EliteHunter","Progress"))	
                else
                    StatusElite:SetDesc("Elite Boss : ðŸ”´no | Killed: "..game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("EliteHunter","Progress"))	
                end
            end)
        end
    end)
    
    local ToggleElite = Tabs.Main:AddToggle("ToggleElite", {Title = "Auto Elite Hunter",Description = "ÄÃ¡nh Boss BÃ­ áº¨n", Default = false })
...
local ToggleSeaBeAst = Tabs.Main:AddToggle("ToggleSeaBeAst", {Title = "Auto Sea Beast",Description = "Treo + ÄÃ¡nh Thá»§y QuÃ¡i", Default = false })
...
local ToggleAutoW = Tabs.Main:AddToggle("ToggleAutoW", {Title = "Auto Press W",Description = "Tá»± Äá»™ng Nháº¥n W", Default = false })
ToggleAutoW:OnChanged(function(Value)
 ...
 spawn(function()
    ...
    Tabs.Main:AddButton({
        ...
        Description = "Bay Äáº¿n Äáº£o BÃ­ áº¨n",
        Callback = function()
            TweenMirage()
        end
    })
    ...
    Tabs.Main:AddButton({
        ...
        Description = "Bay Ä‘áº¿n Chá»— Cao Nháº¥t",
        Callback = function()
            TwenetoHighestPoint()
        end
    })
...
local ToggleTweenGear = Tabs.Main:AddToggle("ToggleTweenGear", {Title = "Tween To Gear",Description = "Nháº·t BÃ¡nh RÄƒng", Default = false })
...
spawn(function()
    ...
    local Togglelockmoon = Tabs.Main:AddToggle("Togglelockmoon", {Title = "Lock Moon and Use Race Skill",Description = "NhÃ¬n TrÄƒng + Báº­t Tá»™c", Default = false })
...
local ToggleMirage = Tabs.Main:AddToggle("ToggleMirage", {Title = "Auto Mirage Island",Description = "Treo Äáº£o BÃ­ áº¨n", Default = false })
ToggleMirage:OnChanged(function(Value)
 ...
 local AutoW = Tabs.Main:AddToggle("AutoW", {Title = "Auto Press W",Description = "Nháº¥n PhÃ­m W", Default = false })
...
if Third_Sea then
    local ToggleHallow = Tabs.Main:AddToggle("ToggleHallow", {Title = "Auto Hallow Scythe [Fully]",Description = "CÃ y LÆ°á»¡i HÃ¡i BÃ³ng Tá»‘i ( Tá»± lÃ m háº¿t )", Default = false })
	...
	spawn(function()
           ...
           local ToggleYama = Tabs.Main:AddToggle("ToggleYama", {Title = "Auto Get Yama",Description = "Láº¥y kiáº¿m Yama", Default = false })
        ...
        local ToggleTushita = Tabs.Main:AddToggle("ToggleTushita", {Title = "Auto Tushita",Description = "ÄÃ¡nh Boss Longma Ä‘á»ƒ lÃ¡y Tushita", Default = false })
        ...
        Options.ToggleTushita:SetValue(false)
           spawn(function()
                   ...
                   local ToggleHoly = Tabs.Main:AddToggle("ToggleHoly", {Title = "Auto Holy Torch",Description = "Tháº¯p Duá»‘c láº¥y Tushita", Default = false })
...
if Second_Sea then
        local ToggleFactory = Tabs.Main:AddToggle("ToggleFactory", {Title = "Auto Farm Factory",Description = "ÄÃ¡nh nhÃ  MÃ¡y", Default = false })
        ...
        if Third_Sea then
    local ToggleCakeV2 = Tabs.Main:AddToggle("ToggleCakeV2", {Title = "Kill Dought King [Need Spawn]",Description = "ÄÃ¡nh TÆ° Lá»‡nh Bá»™t V2 (Cáº§n Triá»‡u Há»“i)", Default = false })
...
if Second_Sea or Third_Sea then
    local ToggleHakiColor = Tabs.Main:AddToggle("ToggleHakiColor", {Title = "Buy Haki Color",Description = "Mua Haki MÃ u",Default = false })
...
if Second_Sea then
    local ToggleSwordLengend = Tabs.Main:AddToggle("ToggleSwordLengend", {Title = "Buy Sword Lengendary",Description = "Mua Kiáº¿m Huyá»n Thoáº¡i",Default = false })
...
if Second_Sea then
    local ToggleEvoRace = Tabs.Main:AddToggle("ToggleEvoRace", {Title = "Auto Evo Race",Description = "Thá»©c Tá»‰nh Tá»™c V2",Default = false })
...
local ToggleFast = Tabs.Setting:AddToggle("ToggleFast", {Title = "Enabled Fast Attack",Description = "ÄÃ¡nh Nhanh", Default = true })
...
spawn(function()
    ...
    local ToggleBringMob = Tabs.Setting:AddToggle("ToggleBringMob", {Title = "Enabled Bring Mob / Magnet",Description = "Gom QuÃ¡i", Default = true })
    ...
    local ToggleBypassTP = Tabs.Setting:AddToggle("ToggleBypassTP", {Title = "Enabled Bypass Tp",Description = "Di Chuyá»ƒn Dáº¡ng Reset", Default = false })
...
local ToggleRemove = Tabs.Setting:AddToggle("ToggleRemove", {Title = " Enabled Remove Dame Text",Description = "áº¨n Dame ÄÃ¡nh QuÃ¡i", Default = true })
...
local ToggleRemoveNotify = Tabs.Setting:AddToggle("ToggleRemoveNotify", {Title = " Enabled Remove All Notify",Description = "áº¨n háº¿t ThÃ´ng bÃ¡o", Default = false })
ToggleRemoveNotify:OnChanged(function(Value)
    ...
    local ToggleWhite = Tabs.Setting:AddToggle("ToggleWhite", {Title = " Enabled White Screen",Description = "MÃ n hÃ¬nh Treo", Default = false })
...
local ToggleZ = Tabs.Setting:AddToggle("ToggleZ", {Title = "Skill Z",Description = "KÄ© NÄƒng Z", Default = true })
ToggleZ:OnChanged(function(Value)
    SkillZ = Value
end)
Options.ToggleZ:SetValue(true)

local ToggleX = Tabs.Setting:AddToggle("ToggleX", {Title = "Skill X", Description = "KÄ© NÄƒng X",Default = true })
...
local ToggleC = Tabs.Setting:AddToggle("ToggleC", {Title = "Skill C",Description = "KÄ© NÄƒng C", Default = true })
...
local ToggleV = Tabs.Setting:AddToggle("ToggleV", {Title = "Skill V",Description = "KÄ© NÄƒng V", Default = true })
...
local ToggleF = Tabs.Setting:AddToggle("ToggleF", {Title = "Skill F",Description = "KÄ© NÄƒng F", Default = false })
...
--Stats
local ToggleMelee = Tabs.Stats:AddToggle("ToggleMelee", {Title = "Auto Melee",Description = "NÃ¢ng Melee", Default = false })
...
local ToggleDe = Tabs.Stats:AddToggle("ToggleDe", {Title = "Auto Defense",Description = "NÃ¢ng MÃ¡u", Default = false })
...
local ToggleSword = Tabs.Stats:AddToggle("ToggleSword", {Title = "Auto Sword",Description = "NÃ¢ng Kiáº¿m", Default = false })
...
local ToggleGun = Tabs.Stats:AddToggle("ToggleGun", {Title = "Auto Gun", Description = "NÃ¢ng SÃºng",Default = false })
...
local ToggleFruit = Tabs.Stats:AddToggle("ToggleFruit", {Title = "Auto Demon Fruit",Description = "NÃ¢ng TrÃ¡i Ãc Quá»·", Default = false })
...
local SelectedPly = Tabs.Player:AddDropdown("SelectedPly", {
    Title = "Select Player",
    Description = "Chá»n NgÆ°á»i ChÆ¡i",
    Values = Playerslist,
    Multi = false,
    Default = 1,
})
...
Tabs.Player:AddButton({
    ...
    Description = "LÃ m Má»›i NgÆ°á»i ChÆ¡i",
    Callback = function()
...
local ToggleTeleport = Tabs.Player:AddToggle("ToggleTeleport", {Title = "Teleport To Player", Description = "Bay Äáº¿n NgÆ°á»i ChÆ¡i",Default = false })
...
local ToggleQuanSat = Tabs.Player:AddToggle("ToggleQuanSat", {Title = "Spectate Player",Description = "Quan sÃ¡t NgÆ°á»i ChÆ¡i", Default = false })
...
local ToggleFastAttack = Tabs.Player:AddToggle("ToggleFastAttack", {Title = " Click Attack Player",Description = "ÄÃ¡nh NgÆ°á»i ChÆ¡i", Default = false })
...
local SliderDelayAttackPlayer = Tabs.Player:AddSlider("SliderDelayAttackPlayer", {
    ...
    Description = "Tá»‘c Ä‘á»™ ÄÃ¡nh (giÃ¢y)",
    Default = 0.1,
    Min = 0,
    Max = 5,
    Rounding = 1,
...
local ToggleShowFov = Tabs.Player:AddToggle("ToggleShowFov", {Title = "Show Fov",Description = "Hiá»‡n Fov", Default = false })
...
local ToggleAimBotSkill = Tabs.Player:AddToggle("ToggleAimBotSkill", {Title = "Auto Aimbot Skill",Description = "Tá»± Äá»™ng ngáº¯m Skill", Default = false })
...
local ToggleNoClip = Tabs.Player:AddToggle("ToggleNoClip", {Title = "No Clip",Description = "XuyÃªn TÆ°á»ng", Default = false })
...
local ToggleWalkonWater = Tabs.Player:AddToggle("ToggleWalkonWater", {Title = "Walk on Water",Description = "Äi TrÃªn nÆ°á»›c", Default = true })
...
local ToggleSpeedRun = Tabs.Player:AddToggle("ToggleSpeedRun", {Title = "Run Speed",Description = "Cháº¡y Nhanh", Default = true })
...
local ToggleEnablePvp = Tabs.Player:AddToggle("ToggleEnablePvp", {Title = "Auto Enable PVP", Description = "Tá»± Ä‘á»™ng báº­t PVP",Default = false })
...
local DropdownFruit = Tabs.Fruit:AddDropdown("DropdownFruit", {
    Title = "Select Fruit",
    Description = "Chá»n TrÃ¡i Ãc Quá»·",
...
local ToggleFruit = Tabs.Fruit:AddToggle("ToggleFruit", {Title = "Buy Fruit Sniper",Description = "Mua TrÃ¡i Ã¡c quá»·", Default = false })
ToggleFruit:OnChanged(function(Value)
...
local ToggleStore = Tabs.Fruit:AddToggle("ToggleStore", {Title = "Store Fruit",Description = "Cáº¥t TrÃ¡i", Default = false })
...
local ToggleRandomFruit = Tabs.Fruit:AddToggle("ToggleRandomFruit", {Title = "Random Fruit",Description = "Äá»•i TrÃ¡i", Default = false })
...
local ToggleCollectTP = Tabs.Fruit:AddToggle("ToggleCollectTP", {Title = "Collect Devil Fruit (TP)",Description = "Nháº·t TrÃ¡i", Default = false })
...
local ToggleCollect = Tabs.Fruit:AddToggle("ToggleCollect", {Title = "Collect Devil Fruit (Tween)",Description = "Nháº·t TrÃ¡i", Default = false })
...
local ToggleEspPlayer = Tabs.Fruit:AddToggle("ToggleEspPlayer", {Title = "Esp Player",Description = "Äá»‹nh vá»‹ ngÆ°á»i chÆ¡i", Default = false })
...
local ToggleEspFruit = Tabs.Fruit:AddToggle("ToggleEspFruit", {Title = "Esp Devil Fruit",Description = "Äá»‹nh vá»‹ TrÃ¡i", Default = false })
...
local ToggleEspIsland = Tabs.Fruit:AddToggle("ToggleEspIsland", {Title = "Esp Island",Description = "Äá»‹nh vá»‹ Ä‘áº£o", Default = false })
...
local ToggleEspFlower = Tabs.Fruit:AddToggle("ToggleEspFlower", {Title = "Esp Flower",Description = "Äá»‹nh vá»‹ Hoa", Default = false })
...
spawn(function()
    ...
    local ToggleStart = Tabs.Raid:AddToggle("ToggleStart", {Title = "Start Raid",Description = "VÃ o Táº­p KÃ­ch", Default = false })
...
local ToggleKillAura = Tabs.Raid:AddToggle("ToggleKillAura", {Title = "Kill Aura",Description = "Giáº¿t QuÃ¡i", Default = false })
...
local ToggleNextIsland = Tabs.Raid:AddToggle("ToggleNextIsland", {Title = "Next Island",Description = "Qua Äáº£o", Default = false })
...
local ToggleAwake = Tabs.Raid:AddToggle("ToggleAwake", {Title = "Auto Awake",Description = "Thá»©c tá»‰nh V2", Default = false })
...
local ToggleGetFruit = Tabs.Raid:AddToggle("ToggleGetFruit", {Title = "Get Fruit Low Bely",Description = "Láº¥y TrÃ¡i Ãt Bely", Default = false })
...
local ToggleLaw = Tabs.Raid:AddToggle("ToggleLaw", {Title = "Auto Law",Description = "Tá»± mua chip + ÄÃ¡nh boss law", Default = false })
...
Tabs.Race:AddButton({
    Title = "Acient One",
    Description = "Npc Mua BÃ¡nh RÄƒng",
    Callback = function()
        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("requestEntrance",Vector3.new(28286.35546875, 14895.3017578125, 102.62469482421875))
...
local ToggleHumanandghoul = Tabs.Race:AddToggle("ToggleHumanandghoul", {Title = "Auto [ Human / Ghoul ] Trial",Description = "HoÃ n thÃ nh Tá»™c quá»· + ngÆ°á»i", Default = false })
...
local ToggleAutotrial = Tabs.Race:AddToggle("ToggleAutotrial", {Title = "Auto Trial",Description = "Tá»¥ Äá»™ng hoÃ n thÃ nh áº£i", Default = false })
...
local ToggleAutoAcientQuest = Tabs.Race:AddToggle("ToggleAutoAcientQuest", {Title = "Auto Train",Description = "cÃ y + báº­t tá»™c", Default = false })
...
Tabs.Shop:AddButton({
	Title = "Geppo",
	Description = "Mua nháº£y liÃªn tá»¥c",
	Callback = function()
...
Tabs.Shop:AddButton({
	Title = "Soru",
	Description = "Mua dá»‹ch chuyá»ƒn (soru)",
	Callback = function()
...
Tabs.Shop:AddButton({
	Title = "Ken Haki",
	Description = "Mua haki quan sÃ¡t",
	Callback = function()
...
Tabs.Misc:AddButton({
	Title = "Rejoin Server",
	Description = "tham gia láº¡i mÃ¡y chá»§",
	Callback = function()
...
Tabs.Misc:AddButton({
	...
	Description = "Má»Ÿ cá»­a hÃ ng trÃ¡i",
	Callback = function()
		game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("GetFruits")
...
Tabs.Misc:AddButton({
	...
	Description = "Má»Ÿ báº£ng danh hiá»‡u",
	Callback = function()
		local args = {
			[1] = "getTitles"
		}
...
Tabs.Misc:AddButton({
	...
	Description = "Má»Ÿ báº£ng thá»©c tá»‰nh chiÃªu",
	Callback = function()
...
Tabs.Misc:AddButton({
	Title = "Rain Fruit",
	Description = "MÆ°a trÃ¡i Ã¡c quá»·",
	Callback = function()
...
local ToggleRejoin = Tabs.Misc:AddToggle("ToggleRejoin", {Title = "Auto Rejoin", Description = "Tá»± Ä‘á»™ng vÃ o láº¡i khi bá»‹ vÄƒng",Default = true })
...
Tabs.Misc:AddButton({
	Title = "Show Items",
	Description = "Hiá»‡n thá»‹ váº­t pháº©m",
	Callback = function()
		do
...
if Third_Sea then
local ToggleFindMoon = Tabs.Hop:AddToggle("ToggleFindMoon", {Title = "Find Full Moon",Description = "TÃ¬m trÄƒng trÃ²n", Default = false })
...
local ToggleMirageIsland = Tabs.Hop:AddToggle("ToggleMirageIsland", {Title = "Find Mirage Island",Description = "TÃ¬m Ä‘áº£o bÃ­ áº©n", Default = false })
...
warn("Fai Fao Hub Loading Completed !!")# Jii
1vexsdz
